...
the selected list remains part of the reproducible URL and task snapshot. URL
restoration deduplicates the list and removes fields outside the current public
catalog so stale shared links cannot create invisible selections or invalid tasks.
