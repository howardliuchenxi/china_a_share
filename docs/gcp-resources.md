...
| Latest ready revision | `china-a-share-lab-00250-5p8` |
| Deployed Git branch | `main` |
| Deployed Git commit | `f3e22c19e20d04d36afbcdf240088f6d5cc3bd79` |
...
| Latest ready revision | `china-a-share-research-sandbox-00009-wpr` |
| Purpose | Execute restricted pandas and NumPy calculations for the Feishu research agent |
| Image | `asia-east2-docker.pkg.dev/china-a-share-lab/cloud-run-source-deploy/china-a-share-lab:f3e22c19e20d04d36afbcdf240088f6d5cc3bd79` |
