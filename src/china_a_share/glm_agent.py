...
GLM_RECOVERY_INSTRUCTIONS = (
    ...
    "- Unit discipline: read each field's unit from the operation catalog "
    "documentation before reporting monetary or volume figures; state the "
    "raw unit and the applied conversion, and sanity-check the magnitude "
